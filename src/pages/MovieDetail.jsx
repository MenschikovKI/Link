  ...
  return (
    ...
    <p style={{ color: "#939cad", fontSize: "2rem", fontWeight: "bolder" }}>О фильме</p>
      ...
      <div className="row mt-3">
        <div className="col">
          <p style={{ color: "#939cad", fontSize: "2rem", fontWeight: "bolder" }}>Жанр</p>
        </div>
      </div>
      ...
      <div className="row mt-3">
        <div className="col">
          ...
          <div className="mt-3">
            <p style={{ color: "#939cad", fontSize: "2rem", fontWeight: "bolder" }}>Обзор</p>
            {detail.overview}
          </div>
        </div>
      </div>
      ...
      <div className="row mt-3">
        <div className="col-md-3">
          <p style={{ color: "#5a606b", fontWeight: "bolder" }}>Премьера</p>
        ...
        <div className="col-md-3">
          <p style={{ color: "#5a606b", fontWeight: "bolder" }}>Домашняя страница</p>
      ...
      <div className="row mt-3">
        <div className="col">
          <p style={{ color: "#939cad", fontSize: "2rem", fontWeight: "bolder" }}>В главных ролях</p>
        </div>
      </div>
      ...
      <div className="row mt-3">
        <div className="col">
          <p style={{ color: "#939cad", fontSize: "2rem", fontWeight: "bolder" }}>
            Похожие фильмы
          </p>
        </div>
      </div>
